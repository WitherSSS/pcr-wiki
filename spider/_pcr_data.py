...
CHARA_NAME = {
    ...
    1165: ["祈梨(时空旅行)", "イノリ(タイムトラベル)", "Inori(TimeTravel)", "祈梨(时间旅行)", "时间旅行龙锤", "穿越龙锤", "穿越梨老八", "军装龙锤", "元首龙锤", "元首", "元老八"],
    1166: ["嘉夜(时空旅行)", "カヤ(タイムトラベル)", "Kaya(TimeTravel)", "嘉夜(时间旅行)", "时间旅行龙拳", "穿越龙拳", "水手龙", "水手龙拳"],
    1167: ["碧(工作服)", "アオイ(作業服)", "Aoi(Sagyoufuku)", "碧(作业服)", "碧(工作服)", "工菜", "韭菜", "工作碧"],
    1168: ["珠希(工作服)", "タマキ(作業服)", "Tamaki(Sagyoufuku)", "珠希(作业服)", "珠希(工作服)", "工猫贼", "工猫剑", "工贼", "工珠希"],
    1169: ["美冬(工作服)", "ミフユ(作業服)", "Mifuyu(Sagyoufuku)", "美冬(作业服)", "美冬(工作服)", "电子龙", "工子龙"],
    ...
    1807: ["初音＆栞", "ハツネ&シオリ", "Hatsune&Shiori","初音＆栞", "星弓", "星栞", "双子弓", "姐妹弓", "姊妹弓", "姐妹丼", "姊妹丼", "贴贴弓", "替身弓", "白金之星", "食堂泼辣酱"],
    1808: ["禊＆美美＆镜华", "ミソギ＆ミミ＆キョウカ", "Misogi&Mimi&Kyouka", "禊＆美美＆镜华", "小小甜心", "狱三家", "小御三家"],
